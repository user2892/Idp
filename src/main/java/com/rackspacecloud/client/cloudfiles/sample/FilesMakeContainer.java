...
public class FilesMakeContainer {
    ...
    // Logger.getLogger(FilesMakeContainer.class);
    public static void main(String args[])
        ...
        try {
            ...
            if (line.hasOption("container")) {
                ...
                // If we got this far there are command line arguments but none
                // of what we expected treat the first one as the Container name
                containerName = args[0];
                createContaier(containerName);
            }
            else {
                System.err.println(
                        "You must provide the -container with a valid value for this to work !");
                System.exit(-1);
            }
        } // end try
    ...
    private static void createContaier(String containerName)
