...
public class RequestEntityWrapper implements HttpEntity {
    ...
    public RequestEntityWrapper(HttpEntity entity,
     ...
     * (non-Javadoc)
     * @see
     * org.apache.commons.httpclient.methods.RequestEntity#writeRequest(java.io.
     * OutputStream) public void writeRequest(OutputStream stream) throws
     * IOException { ((RequestEntityWrapper) entity).writeRequest(new
     * OutputStreamWrapper(stream, callback)); }
     */
