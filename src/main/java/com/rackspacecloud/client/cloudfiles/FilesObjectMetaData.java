...
public class FilesObjectMetaData {
     ...
     * @param eTag
     *            The MD5 check-sum of the object's contents
     * @param lastModified
     *            The last time the object was modified.
     */
    public FilesObjectMetaData(String mimeType, String contentLength,
    ...
    /**
     * Set new metatdata for this object. Warning, this metadata clears out all
     * old metadata. To add new fields, use <code>setMetaData</code> instead.
     * 
     * @param metaData
     *            The new metadata
     */
