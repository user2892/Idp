...
public class FilesUtil {
    ...
    private static synchronized void loadPropertiesFromClasspath()
        ...
        if (io == null) {
            throw new FileNotFoundException(
                    "Property file '" + file + "' not found in the classpath.");
        }
        loadProperties(io);
    }
    ...
    /**
     * Looks up the value of a key from the properties file and converts it to
     * an integer.
     *
     * @param key
    ...
    public static int getIntProperty(final String key) {
        ...
        try {
            ...
            logger.warn("Invalid format for a number in properties file: "
                    + property + ".", e);
            return -1;
        }
    }
