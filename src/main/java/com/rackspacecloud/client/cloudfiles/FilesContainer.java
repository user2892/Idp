...
public class FilesContainer {
    ...
    /**
     * Create a new container (Note, this does not actually create a container
     * on the server)
     * 
     * @param name
     ...
     */
    public FilesContainer(String name, List<FilesObject> objs,
            FilesClient client) {
        this.name = name;
        this.objects = objs;
        this.client = client;
     ...
     */
    public List<FilesObject> getObjects()
    ...
    public List<FilesObject> getObjects(String path) throws HttpException,
            IOException, FilesAuthorizationException, FilesException {
        if (client != null) {
            if (objects == null) {
     ...
     * @throws FilesInvalidNameException
     */
    public boolean addObject(File f, String mimeType)
        ...
        logger.fatal(
                "Could not add Object, it seems something is wrong with this Container or FilesClient");
        return false;
    }
     ...
     *
     * @return Either FilesConstants.CONTAINER_CREATED or
     *         FilesConstants.CONTAINER_EXISTED or -1 if the client has not been
     *         set
     * @throws HttpException
     * @throws IOException
     * @throws FilesAuthorizationException
     * @throws FilesInvalidNameException
     */
    public void createContainer() throws HttpException, IOException,
            FilesAuthorizationException, FilesException {
        if (client != null) {
