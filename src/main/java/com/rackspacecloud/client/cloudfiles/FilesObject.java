...
public class FilesObject {
     ...
     * 
     * @param obj
     *            A file representing the object
     * @param mimeType
     *            Its MIME type
     * @param container
     *            The container it lives in
     * @throws NullPointerException
     *             A null parameter was passed in
     * @throws NoSuchAlgorithmException
     *             MD5 was not installed on the client.
     * @throws IOException
     *             There was an I/O error talking to the server
     */
    FilesObject(File obj, String mimeType, FilesContainer container)
            throws NullPointerException, NoSuchAlgorithmException, IOException {
        if (obj != null) {
            if (obj.exists()) {
                if (!obj.isDirectory()) {
                    setName(obj.getName());
                    ...
                    logger.fatal(
                            "Can not create Directories as FSObjects create a FilesContainer for this object");
                    throw new NullPointerException(
                            "File Object was a directory !");
                }
            }
            else {
                logger.fatal(
                        "File object must exist so we can create an MD5SUM for it !");
                throw new NullPointerException(
                        "The file object provided does not exist.");
            }
        }
        else {
            logger.fatal(
                    "Not possible to create a FilesObject from a null File.");
     ...
     * @param client
     *            The client it can be accessed through.
     */
    ...
    public void setName(String name) {
        if (name.length() > FilesConstants.OBJECT_NAME_LENGTH) {
            logger.warn("Object name larger than "
                    + FilesConstants.OBJECT_NAME_LENGTH
                    + " characters truncating from: " + name);
    ...
    /**
     * @param mimeType
     *            The new MIME type for this object
     */
    ...
    /**
     * @param md5sum
     *            The MD5 sum of the file (as a hex-encoded string)
     */
     ...
     * @throws IOException
     *             There was an I/O exception communicating with the server or
     *             writing the file.
     * @throws FilesAuthorizationException
     * @throws FilesInvalidNameException
     */
    public long writeObjectToFile(File localFile)
            throws HttpException,
            FilesAuthorizationException, FilesInvalidNameException, IOException {
        long bytesWritten = 0;
        FileOutputStream out=null;
        InputStream in=null;
        try {
            out = new FileOutputStream(localFile);
            in = getObjectAsStream();
    ...
    public byte[] getObject()
            throws HttpException, IOException, FilesAuthorizationException,
    ...
    public FilesObjectMetaData getMetaData() throws HttpException, IOException,
            FilesAuthorizationException, FilesInvalidNameException {
        FilesObjectMetaData metaData = client.getObjectMetaData(container,
                name);
        if (metaData != null) {
    ...
    /**
     * @param client
     *            The new client for this object
     */
    ...
    public static FilesObject uploadObject(File obj, String mimeType,
    ...
    public static FilesObject uploadObject(File obj, String mimeType,
        ...
        try {
            ...
            client.storeObjectAs(container.getName(), obj, mimeType,
     ...
     */
    public String getLastModified() throws HttpException, IOException,
            FilesAuthorizationException, FilesInvalidNameException {
    ...
    /**
     * @return The CDN url for the object (if its container has been CDN
     *         enabled), null if the container hasn't been CDN enabled.
     * @throws HttpException
     * @throws IOException
     * @throws FilesException
     */
    public String getCDNURL()
            throws FilesException, IOException, HttpException {
        try {
