...
public class FilesResponse {
    ...
    /**
     * @param method
     *            The HttpMethod that generated this response
     */
    ...
    /**
     * This method makes no assumptions about the user having been logged in. It
     * simply looks for the Storage Token header as defined by
     * FilesConstants.X_STORAGE_TOKEN and if this exists it returns its value
     * otherwise the value returned will be null.
     *
     * @return null if the user is not logged into Cloud FS or the Storage token
     */
    public String getAuthToken() {
        return getResponseHeader(FilesUtil.getProperty("auth_token_name",
                FilesConstants.X_AUTH_TOKEN)).getValue();
    }

    /**
     * This method makes no assumptions about the user having been logged in. It
     * simply looks for the Storage URL header as defined by
     * FilesConstants.X_STORAGE_URL and if this exists it returns its value
     * otherwise the value returned will be null.
     *
    ...
    /**
     * This method makes no assumptions about the user having been logged in. It
     * simply looks for the CDN Management URL header as defined by
     * FilesConstants.X_CDN_MANAGEMENT_URL and if this exists it returns its
     * value otherwise the value returned will be null.
     *
     * @return null if the user is not logged into Cloud FS or the Storage URL
     */
    ...
    /**
     * The HTTP Method (put, get, etc) of the request that generated this
     * response
     * 
     * @return The method name
     */
    /*
     * public String getMethodName () { return response.getName(); }
     */
    /**
     ...
     * @return The specified response header. If the response contained multiple
     ...
     * 
     * @return -1 if the header is not present or the correct value as defined
     *         by the header
     */
    public int getContainerObjectCount() {
        Header contCountHeader = getResponseHeader(
                FilesConstants.X_CONTAINER_OBJECT_COUNT);
    ...
    public long getContainerBytesUsed() {
        Header contBytesUsedHeader = getResponseHeader(
                FilesConstants.X_CONTAINER_BYTES_USED);
    ...
    public int getAccountContainerCount() {
        Header contCountHeader = getResponseHeader(
                FilesConstants.X_ACCOUNT_CONTAINER_COUNT);
        if (contCountHeader != null)
            return Integer.parseInt(contCountHeader.getValue());
        return -1;
    }
    ...
    public long getAccountBytesUsed() {
        Header accountBytesUsedHeader = getResponseHeader(
                FilesConstants.X_ACCOUNT_BYTES_USED);
     ...
     * 
     * @return null if the header is not present or the correct value as defined
     *         by the header
     */
    ...
    public String getCdnStreamingUrl() {
        Header cdnHeader = getResponseHeader(
                FilesConstants.X_CDN_Streaming_URI);
        if (cdnHeader != null)
            return cdnHeader.getValue();
        return null;
    }
