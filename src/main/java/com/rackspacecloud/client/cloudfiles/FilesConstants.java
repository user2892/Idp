...
public class FilesConstants {
    ...
    /**
     * HTTP Header used by Cloud Files for the MD5Sum of the object being
    ...
    /**
     * These constants are used for performing queries on the content of a
     * container
     **/
    ...
    static {
        ...
        try {
            ...
            in = FilesConstants.class.getResourceAsStream("MIME.types");
            MIMETYPES.load(in);
        }
        catch (IOException err) {
            logger.warn(
                    "Could not load MIME.types all refrences to FilesConstants.MIMETYPES will return null.",
                    err);
        }
        finally{
            if(in!=null){
    ...
    /**
     * Convenience method to get a MIME Type. If none is found it will return
    ...
    public static String getMimetype(String fileExt) {
        return FilesConstants.MIMETYPES.getProperty(fileExt.toLowerCase(),
                "application/octet-stream");
    }
}
