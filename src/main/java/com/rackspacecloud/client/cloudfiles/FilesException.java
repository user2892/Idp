...
public class FilesException extends HttpException {
    ...
    /**
     * An exception generated when a client tries to do something they aren't
     * authorized to do.
     * 
     * @param message
     *            The message
    ...
    public FilesException(String message, Header[] httpHeaders,
        ...
        super(message);
        this.httpHeaders = httpHeaders == null ? null : httpHeaders.clone();
    ...
    public Header[] getHttpHeaders() {
        return httpHeaders == null ? null : httpHeaders.clone();
    }

    /**
     * @return The HTTP Headers returned by the server in a human-readable
     *         string.
     */
    ...
    public String getHttpVersion() {
        return httpStatusLine == null ? null
                : httpStatusLine.getProtocolVersion().toString();
    }
}
