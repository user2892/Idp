 ...
 */
public class IDPJSONMsgListenerImpl implements MessageListener {
    // --------------------------------------------------------------- Constants
    // --------------------------------------------------------- Class Variables
    // ----------------------------------------------------- Static Initializers
    // ------------------------------------------------------ Instance Variables
    ...
    public void onMessage(Message message) {
        ...
        try {
            //System.out.println("in JSON Listener*************");
            if (message instanceof ObjectMessage) {
                ...
                if (object instanceof IDPMsgBean) {
                    ...
                    // new IDPCustomerHelper().pushCustomerJSONData(idpMsgBean);
    ...
    private static  HttpPost directPostPair(HttpPost httpPost, IDPMsgBean idpMsgBean){
        ...
        StringEntity customerEntity=new StringEntity(responseData.toString(), ContentType.APPLICATION_JSON);
